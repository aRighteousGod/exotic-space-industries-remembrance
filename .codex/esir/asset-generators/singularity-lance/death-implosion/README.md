# ei-singularity-lance-death-implosion

2D procedural custom death explosion for `ei-singularity-lance`.
...
```powershell
python .\.codex\esir\asset-generators\singularity-lance\death-implosion\generate_singularity_lance_death_implosion.py --promote
```
