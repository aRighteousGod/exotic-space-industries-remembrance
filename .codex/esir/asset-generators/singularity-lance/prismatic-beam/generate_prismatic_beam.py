...
ASSET_NAME = "ei-singularity-lance-prismatic-beam"
...
-- Copy PNGs into graphics/entities/singularity-lance/beam/ before using this.
-- Leave ei-singularity-lance-trigger-beam unchanged; it is the hidden script trigger carrier.
...
-- singularity_beam.graphics_set = make_prismatic_beam_graphics_set(0.34)
-- singularity_impact_beam.graphics_set = make_prismatic_beam_graphics_set(0.42)
...
def write_manifest(specs: list[SheetSpec], previews: list[Path]) -> dict[str, object]:
    ...
    manifest = {
        ...
        "target_prototype_names": ["ei-singularity-lance-beam", "ei-singularity-lance-impact-beam"],
        "do_not_modify": ["ei-singularity-lance-trigger-beam"],
        ...
        "promotion": {
            "copy_assets_to": "exotic-space-industries-remembrance/graphics/entities/singularity-lance/beam/",
            ...
            "notes": [
                ...
                "Run preflight and Singularity Lance QC only after promotion is requested.",
            ],
        },
        "warnings": warnings,
    }
