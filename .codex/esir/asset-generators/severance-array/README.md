# Severance Array Asset Generators
...
- `icons/generate_severance_array_icons.py`: item and technology icon source/overlay generation.
- `crystal-link/generate_crystal_link.py`: separate base-to-crystal connector sheet, sourced from the chromatic beam style but promoted to `graphics/entities/severance-array/crystal-link/`.

## Output Policy

- Keep `output/meshy/ei-severance-array-*` ignored.
