...
ASSET_NAME = "ei-severance-array-chromatic-afterburn"
...
def write_snippet() -> None:
    snippet = """-- Staged non-impact afterburn graphics for ei-severance-array.
-- Promote these sheets to graphics/entities/severance-array/afterburn/ before using.
local afterburn_path = ei_path.."graphics/entities/severance-array/afterburn/"
...
def main() -> None:
    ...
    outputs = {
        "ei-severance-array-afterburn-fire.png": fire,
        "ei-severance-array-afterburn-fire-glow.png": fire_glow,
        "ei-severance-array-afterburn-sticker.png": sticker,
        "ei-severance-array-afterburn-sticker-glow.png": sticker_glow,
        "ei-severance-array-afterburn-scorchmark.png": scorch,
        "ei-severance-array-afterburn-scorchmark-glow.png": scorch_glow,
    }
    for filename, sheet in outputs.items():
        sheet.save(EXPORT_DIR / filename)

    specs = [
        SheetSpec(EXPORT_DIR / "ei-severance-array-afterburn-fire.png", FIRE_SIZE, FIRE_FRAMES, FIRE_LINE_LENGTH),
        SheetSpec(EXPORT_DIR / "ei-severance-array-afterburn-fire-glow.png", FIRE_SIZE, FIRE_FRAMES, FIRE_LINE_LENGTH),
        SheetSpec(EXPORT_DIR / "ei-severance-array-afterburn-sticker.png", STICKER_SIZE, STICKER_FRAMES, STICKER_LINE_LENGTH),
        SheetSpec(EXPORT_DIR / "ei-severance-array-afterburn-sticker-glow.png", STICKER_SIZE, STICKER_FRAMES, STICKER_LINE_LENGTH),
        SheetSpec(EXPORT_DIR / "ei-severance-array-afterburn-scorchmark.png", SCORCH_SIZE, SCORCH_VARIATIONS, SCORCH_VARIATIONS),
        SheetSpec(EXPORT_DIR / "ei-severance-array-afterburn-scorchmark-glow.png", SCORCH_SIZE, SCORCH_VARIATIONS, SCORCH_VARIATIONS),
    ]
