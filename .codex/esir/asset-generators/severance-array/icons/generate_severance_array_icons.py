...
ASSET_NAME = "ei-severance-array-icons"
...
ENTITY_DIR = REPO_ROOT / "exotic-space-industries-remembrance" / "graphics" / "entities" / "severance-array"
...
ITEM_ICON = "ei-severance-array.png"
ITEM_OVERLAY_ICON = "ei-severance-array-chromatic-overlay.png"
TECH_ICON = "ei-severance-array.png"
TECH_OVERLAY_ICON = "ei-severance-array-chromatic-overlay.png"
...
def make_entity_composite() -> Image.Image:
    body = first_frame("ei-severance-array.png")
    crystal = first_frame("ei-severance-array_crystal.png")
...
def make_identity_layout(size: int, tech: bool = False) -> Image.Image:
    body = boost_layer(crop_subject(first_frame("ei-severance-array.png")))
    crystal = boost_layer(crop_subject(first_frame("ei-severance-array_crystal.png")))
...
def write_report(
    ...
    report = {
        ...
        "outputs": [
            {
                "path": "graphics/items/ei-severance-array.png",
            ...
            {
                "path": "graphics/items/ei-severance-array-chromatic-overlay.png",
            ...
            {
                "path": "graphics/techs/ei-severance-array.png",
                "size": list(tech_base.size),
                "icon_size": 256,
                "mode": tech_base.mode,
            },
            {
                "path": "graphics/techs/ei-severance-array-chromatic-overlay.png",
...
def main() -> None:
    ...
    item_base.save(EXPORT_DIR / "ei-severance-array-source-128.png")
    item_overlay.save(EXPORT_DIR / "ei-severance-array-chromatic-overlay-source-128.png")
    composite_layers(item_base, item_overlay).save(EXPORT_DIR / "ei-severance-array-ui-composite-128.png")
    item_strip.save(EXPORT_DIR / ITEM_ICON)
    item_overlay_strip.save(EXPORT_DIR / ITEM_OVERLAY_ICON)
    tech_base.save(EXPORT_DIR / "ei-severance-array-tech.png")
    tech_overlay.save(EXPORT_DIR / "ei-severance-array-tech-chromatic-overlay.png")
