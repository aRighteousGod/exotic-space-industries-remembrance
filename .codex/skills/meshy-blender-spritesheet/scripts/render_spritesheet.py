...
def write_manifest(path: Path, args: argparse.Namespace, frame_paths: list[Path], sheet_size: tuple[int, int]) -> None:
...
def main() -> None:
    ...
    write_manifest(manifest, args, frame_paths, sheet_size)
