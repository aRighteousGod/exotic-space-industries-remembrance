...
{
  {
    ...
    icon = "__exotic-space-industries-remembrance__/teslas_legacy/graphics/tank/icons/Teslatankcannon.png",
    ...
    attack_parameters =
    {
	  ...
	  --{
      --  {
      --    filename = "__exotic-space-industries-remembrance__/teslas_legacy/sound/earcing.ogg",
      --    volume = 0.5
      --  }
      --}
    },
