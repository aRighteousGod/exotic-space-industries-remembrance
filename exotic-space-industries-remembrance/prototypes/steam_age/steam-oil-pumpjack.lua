...
data:extend({
    {
        ...
        order = "b[fluids]-b",
        place_result = "ei-steam-oil-pumpjack",
        stack_size = 20
    },
    {
        name = "ei-steam-oil-pumpjack",
        ...
        results = {{type="item", name="ei-steam-oil-pumpjack", amount=1}},
        enabled = false,
        always_show_made_in = true,
        main_product = "ei-steam-oil-pumpjack",
    },
    {
        name = "ei-steam-oil-processing",
        type = "technology",
        icon = ei_graphics_tech_path.."steam-oil-processing.png",
        icon_size = 128,
        prerequisites = {"ei-burner-heater"},
        effects = {
            {
                type = "unlock-recipe",
                recipe = "ei-steam-oil-pumpjack"
            },
            {
                type = "unlock-recipe",
                recipe = "oil-refinery"
            ...
            {
                type = "unlock-recipe",
                recipe = "ei-heat-chemical-plant"
            },
            {
                type = "unlock-recipe",
                recipe = "ei-solid-fuel-residual-oil"
            },
            {
                type = "unlock-recipe",
...
pump.name = "ei-steam-oil-pumpjack"
pump.icon = ei_graphics_item_path.."steam-oil-pumpjack.png"
pump.icon_size = 64
pump.minable.result = "ei-steam-oil-pumpjack"
