...
data:extend({
    {
        ...
        results = {
            {type = "item", name = "ei-charged-grenade", amount = 1},
        },
        always_show_made_in = true,
        enabled = false,
        main_product = "ei-charged-grenade",
    },
    {
        name = "ei-charged-grenade",
        type = "technology",
        ...
        icon_size = 256/2,
        prerequisites = {"ei-grower", "stronger-explosives-2"},
        effects = {
            {
                type = "unlock-recipe",
                recipe = "ei-charged-grenade"
            },
        },
        unit = {
            count = 100,
...
ei_explosion.name = 'ei-charged-grenade-explosion'
local ei_grenade = table.deepcopy(data.raw['projectile']['grenade'])
ei_grenade.name = 'ei-charged-grenade'
...
ei_grenade.action = {
  {
    ...
    action_delivery = {
      ...
      target_effects = {
        {
          type = 'create-entity',
          entity_name = 'ei-charged-grenade-explosion',
...
ei_capsule.name = 'ei-charged-grenade'
