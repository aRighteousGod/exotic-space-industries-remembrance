...
data:extend({
    ...
    },
    {
        ...
        results = {
           ...
           {type = "item", name = "ei-high-energy-crystal", amount = 1, probability=0.98,ignored_by_stats=1},
            ...
            {type= "item",name="ei-lead-chunk", amount_min=1, amount_max=3,probability=0.12},
            {type= "item",name="ei-sulfur-chunk", amount_min=1, amount_max=3,probability=0.14},
            {type= "item",name="ei-uranium-chunk", amount_min=1, amount_max=3,probability=0.018},
            {type= "item",name="ei-neodym-chunk", amount_min=1, amount_max=3,probability=0.008},
        },
        always_show_made_in = true,
        enabled = false,
    ...
    {
        name = "ei-slag-extraction-nitric",
        type = "recipe",
        category = "ei-purifier",
        energy_required = 8,
        ingredients = {
        ...
        results = {
            ...
            {type= "item",name="ei-gold-chunk", amount_min=0, amount_max=2,probability=0.04},
            {type= "item",name="ei-lead-chunk", amount_min=0, amount_max=2,probability=0.06},
            {type= "item",name="ei-sulfur-chunk", amount_min=0, amount_max=2,probability=0.07},
            {type= "item",name="ei-uranium-chunk", amount_min=0, amount_max=2,probability=0.009},
            {type= "item",name="ei-neodym-chunk", amount_min=0, amount_max=2,probability=0.004},
        },
        always_show_made_in = true,
        enabled = false,
        subgroup = "ei-refining-purified",
    ...
    },
    {
        ...
        results = {
            ...
            {type= "item",name="ei-gold-chunk", amount_min=0, amount_max=1,probability=0.02},
            {type= "item",name="ei-lead-chunk", amount_min=0, amount_max=1,probability=0.03},
            {type= "item",name="ei-sulfur-chunk", amount_min=0, amount_max=1,probability=0.035},
            {type= "item",name="ei-uranium-chunk", amount_min=0, amount_max=1,probability=0.0045},
            {type= "item",name="ei-neodym-chunk", amount_min=0, amount_max=1,probability=0.002},
        },
        always_show_made_in = true,
        enabled = false,
        subgroup = "ei-refining-purified",
