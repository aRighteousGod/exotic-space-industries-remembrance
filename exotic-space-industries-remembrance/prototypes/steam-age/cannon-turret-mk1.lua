...
table.insert(
	...
	{ type = "turret-attack", turret_id = "ei-cannon-turret-mk1", modifier = 0.05 }
)
table.insert(
...
table.insert(
	...
	{ type = "turret-attack", turret_id = "ei-cannon-turret-mk1", modifier = 0.1 }
)
table.insert(
...
table.insert(
	...
	{ type = "turret-attack", turret_id = "ei-cannon-turret-mk1", modifier = 0.2 }
)
