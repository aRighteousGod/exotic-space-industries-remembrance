    ...
    icons = {
        {
            ...
            icon_size = data.raw.item["engine-unit"].icon_size,
            icon_mipmaps = data.raw.item["engine-unit"].icon_mipmaps,
            scale = 0.40625,
            shift = {3, 3},
        },
        {
            ...
            icon_mipmaps = data.raw.fluid["heavy-oil"].icon_mipmaps,
            scale = 0.375,
            shift = {-8, -8},
