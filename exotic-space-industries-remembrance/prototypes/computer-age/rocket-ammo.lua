...
local rocket_airframe_icon = rocket_items_path .. "rocket-airframe.png"
local rocket_motor_basic_icon = rocket_items_path .. "rocket-motor-basic.png"
local rocket_motor_high_energy_icon = rocket_items_path .. "rocket-motor-high-energy.png"
local rocket_warhead_impact_icon = rocket_items_path .. "rocket-warhead-impact.png"
local rocket_warhead_explosive_icon = rocket_items_path .. "rocket-warhead-explosive.png"
local rocket_warhead_siege_icon = rocket_items_path .. "rocket-warhead-siege.png"
local rocket_warhead_corrosive_icon = rocket_items_path .. "rocket-warhead-corrosive.png"
local rocket_warhead_cryo_icon = rocket_items_path .. "rocket-warhead-cryo.png"
local rocket_warhead_atomic_u235_icon = rocket_items_path .. "rocket-warhead-atomic-u235.png"
local rocket_warhead_atomic_plutonium_icon = rocket_items_path .. "rocket-warhead-atomic-plutonium.png"
local corrosive_rocket_icon = rocket_items_path .. "corrosive-rocket.png"
local cryo_rocket_icon = rocket_items_path .. "cryo-rocket.png"
local atomic_bomb_u235_icon = rocket_items_path .. "atomic-bomb-u235.png"
local atomic_bomb_plutonium_icon = rocket_items_path .. "atomic-bomb-plutonium.png"

local corrosive_rocketry_tech_icon = rocket_techs_path .. "corrosive-rocketry.png"
local cryo_rocketry_tech_icon = rocket_techs_path .. "cryo-rocketry.png"
local atomic_bomb_tech_icon = rocket_techs_path .. "atomic-bomb.png"
local plutonium_warheads_tech_icon = rocket_techs_path .. "plutonium-warheads.png"
