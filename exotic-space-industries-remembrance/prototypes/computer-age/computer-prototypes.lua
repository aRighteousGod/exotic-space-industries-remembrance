    ...
    --basic cryogenic fractionation
{
        ...
        icon = ei_graphics_3_path.."graphics/icons/cryogenic-fractionation.png",
        icon_size = 512,
        icon_mipmaps = 5,
        subgroup = "fluid-recipes",
    ...
    --basic oxidative cracking
{
        ...
        icon = ei_graphics_3_path.."graphics/icons/oxidative-cracking.png",
        icon_size = 512,
        icon_mipmaps = 5,
        subgroup = "fluid-recipes",
    ...
    --basic Acid Hydrolysis / Nitration
{
        ...
        icon = ei_graphics_3_path.."graphics/icons/acid-hydrolysis-nitration.png",
        icon_size = 512,
        icon_mipmaps = 5,
        subgroup = "fluid-recipes",
...
data:extend({
    ...
    },
    {
        ...
        icon_size = 256,
        icon_mipmaps = 4,
        prerequisites = {"military-4", "automation-3", "ei-computer-core","exoskeleton-equipment"},
        effects = {
            {
                type = "unlock-recipe",
