...
data:extend({
	...
	},
    {
        name = "ei-shotgun-turret",
        type = "technology",
		icon = ei_path .. "graphics/tech/shotgun-turret.png",
		icon_size = 512,
		icon_mipmaps = 5,
...
data:extend({
    {
        type = "ammo",
        name = "dragons-breath-shotgun-shell",
        icon = "__pasts-defense-stuff__/graphics/icons/dragons-breath-shotgun-shell.png",
        ...
        ammo_type = {
            ...
            action =
            {
              ...
              },
              {
                ...
                {
                  type = "projectile",
                  projectile = "dragons-breath-shotgun-pellet",
                  starting_speed = 1,
