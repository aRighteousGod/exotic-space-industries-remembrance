...
data:extend({
    ...
    },
    {
        ...
        icon_size = 256,
        prerequisites = {"solar-energy", "ei-grower"},
        effects = {
            {
                type = "unlock-recipe",
                recipe = "ei-solar-panel-2"
            }
        },
        unit = {
            count = 100,
    ...
    },
    {
        ...
        results = {{type="item", name="ei-solar-panel-2", amount=1}},
        enabled = false,
        always_show_made_in = true,
        main_product = "ei-solar-panel-2",
    },
})
