...
-- forwarded_events: ages_and_tech, artifacts, asteroid_variants, auric_fumarole, beacon_overhaul, black_hole, bots, cranes_and_belts, em_trains, enemy_difficulty, exotic_industries_informatron, exotic_stabilizer, fission, fulgora_day_variation, fusion_power, game_related, gate, induction_matrix, knowledge, loaders, menu, mining_scars, nauvis_pressure_grace, neutron_collector, new_logistics, new_mechanics, nuclear_fission_and_fusion, orbital_scanner, overall, page_content, railgun_cooling, repair, resources, rocket_launch_pollution, specialised_pipes, tech_scaling, teslas_legacy, train_progression, turrets, world_gen_related
-- storage_roots: none
