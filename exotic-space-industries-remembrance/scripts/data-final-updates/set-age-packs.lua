...
ei_lib.set_age_packs("laser-weapons-damage-7","exotic-age")
...
ei_lib.set_age_packs("refined-flammables-6","advanced-computer-age")
...
ei_lib.set_age_packs("coal-liquefaction","computer-age-space-vulcanus")
