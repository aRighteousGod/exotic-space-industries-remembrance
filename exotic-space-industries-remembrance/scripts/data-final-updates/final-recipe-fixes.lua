...
data.raw.recipe["ei-liquid-nitrogen"].crafting_machine_tint = {
	primary = { r = 0.100, g = 0.850, b = 0.900, a = 1.000 }, -- #1ad9e6ff  bright turquoise
	secondary = { r = 0.050, g = 0.350, b = 1.000, a = 1.000 }, -- #0d59ffff  deep cryo blue
	tertiary = { r = 0.100, g = 0.100, b = 0.120, a = 1.000 }, -- #1a1a1fff  cold dark neutral
	quaternary = { r = 0.700, g = 1.000, b = 1.000, a = 1.000 }, -- #b2ffffff  icy highlight
}
data.raw.recipe["ei-liquid-oxygen"].crafting_machine_tint = {
	primary = { r = 0.950, g = 0.100, b = 0.100, a = 1.000 }, -- #f21a1aff  oxygen red
	secondary = { r = 1.000, g = 0.450, b = 0.100, a = 1.000 }, -- #ff731aff  hot orange-red accent
	tertiary = { r = 0.120, g = 0.080, b = 0.080, a = 1.000 }, -- #1f1414ff  deep shadow
	quaternary = { r = 1.000, g = 0.700, b = 0.700, a = 1.000 }, -- #ffb2b2ff  pale highlight
}
data.raw.recipe["ei-vaporize-liquid-nitrogen"].crafting_machine_tint = {
	primary = { r = 0.180, g = 0.750, b = 0.780, a = 1.000 }, -- #2ebfc7ff  muted turquoise
	secondary = { r = 0.100, g = 0.350, b = 0.800, a = 1.000 }, -- #1a59ccff  softer deep blue
	tertiary = { r = 0.110, g = 0.110, b = 0.130, a = 1.000 }, -- #1c1c21ff  cool dark neutral
	quaternary = { r = 0.780, g = 0.950, b = 0.950, a = 1.000 }, -- #c7f2f2ff  pale icy highlight
}
data.raw.recipe["ei-vaporize-liquid-oxygen"].crafting_machine_tint = {
	primary = { r = 0.850, g = 0.180, b = 0.180, a = 1.000 }, -- #d92e2eff  softened oxygen red
	secondary = { r = 0.950, g = 0.500, b = 0.200, a = 1.000 }, -- #f28033ff  warm orange-red accent
	tertiary = { r = 0.130, g = 0.090, b = 0.090, a = 1.000 }, -- #211717ff  deep shadow
	quaternary = { r = 0.980, g = 0.780, b = 0.780, a = 1.000 }, -- #fac7c7ff  pale highlight
}
data.raw.recipe["ei-liquid-ammonia"].crafting_machine_tint = {
	primary = { r = 0.920, g = 0.980, b = 0.970, a = 1.000 }, -- #ebfaf7ff  pearl-white
	secondary = { r = 0.700, g = 0.900, b = 0.850, a = 1.000 }, -- #b2e6d9ff  pale mint accent
	tertiary = { r = 0.120, g = 0.130, b = 0.130, a = 1.000 }, -- #1f2121ff  cool dark neutral
	quaternary = { r = 0.980, g = 1.000, b = 1.000, a = 1.000 }, -- #faffffff  icy highlight
}
data.raw.recipe["ei-vaporize-liquid-ammonia"].crafting_machine_tint = {
	primary = { r = 0.900, g = 0.950, b = 0.940, a = 1.000 }, -- #e6f2f0ff  fog-white
	secondary = { r = 0.720, g = 0.860, b = 0.820, a = 1.000 }, -- #b8dbd1ff  muted mint
	tertiary = { r = 0.130, g = 0.140, b = 0.140, a = 1.000 }, -- #212424ff  cool shadow
	quaternary = { r = 0.960, g = 0.990, b = 0.990, a = 1.000 }, -- #f5fcfcff  soft highlight
}
