...
set_int("tesla_legacy_sa","tl-tank-health",5000)
set_int("tesla_legacy_sa","tl-tank-damage",400)
set_float("tesla_legacy_sa","tl-tank-fire-rate",1)
set_int("tesla_legacy_sa","tl-tank-range",35)
