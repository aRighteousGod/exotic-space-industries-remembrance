...
require("scripts/data-updates/atan_air_scrubber.lua")
require("scripts/data-updates/atan_ash.lua")
require("scripts/data-updates/pollution_combinator_jamie_fork.lua")